...
import com.huancheng.learngtool.ui.CalculationActivity;
import com.huancheng.learngtool.ui.MainActivity;
...
public class GridViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view;
        if (convertView == null) {
            view = LayoutInflater.from(CalculationActivity.activity).inflate(layoutId, parent, false);
        ...
        if (layoutId == R.layout.button_operator) {
            if (deleteParam == null)
                deleteParam = CalculationActivity.activity.delete.getLayoutParams();
            if (deleteParam.height != height / rows) {
                deleteParam.height = height / rows;
                CalculationActivity.activity.delete.setLayoutParams(deleteParam);
            }
        }
