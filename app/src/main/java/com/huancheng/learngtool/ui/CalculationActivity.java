...
import com.huancheng.learngtool.adapter.GridViewAdapter;
import com.huancheng.learngtool.adapter.MainPagerAdapter;
import com.huancheng.learngtool.util.AutofitHelper;
import com.huancheng.learngtool.util.Constants;
import com.huancheng.learngtool.util.ExpressionHandler;
...
public class CalculationActivity extends BaseActivity {
    ...
    public static CalculationActivity activity;
    ...
    private void initTop() {
        final TextView calculation_all = findViewById(R.id.calculation_all);
        calculation_all.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View view) {
               if (calculation_all.getText().equals("全屏")){
                   setGodMode(true);
                   calculation_all.setText("退出全屏");
               }else {
                   setGodMode(false);
                   calculation_all.setText("全屏");
               }
           }
       });
       findViewById(R.id.calculation_help).setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View view) {
               AlertDialog.Builder dialog = new AlertDialog.Builder(CalculationActivity.this);
               dialog.setTitle("帮助")
